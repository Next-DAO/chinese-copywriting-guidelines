...
- [4. Emoji 使用规范](#4-Emoji-使用规范)
  * [文字结尾与 Emoji 之间的空格可加可不加](#文字结尾与-Emoji-之间的空格可加可不加)
  * [保持礼貌，避免使用有攻击性或侮辱性的 Emoji](#保持礼貌，避免使用有攻击性或侮辱性的-Emoji)
    
- [5. 以下规则推荐遵守，但不作强制要求](#5-以下规则推荐遵守但不作强制要求)
